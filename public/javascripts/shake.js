$(document).ready(function() {
  $('#shake').click(function () {
    $(this).effect("shake");
    var eightArr = ["You're too good for him.", "If he says he'll call the next day, in boy time that means Thursday.",
      "You are just totally clueless.", "Make sure he sees you, but don't say hi first.",
      ...
      "You two don't make any sense.", "You know you're gorgeous, alright? And popular.", 
      "Send yourself love letters, flowers and candy so he sees how desired you are.",
